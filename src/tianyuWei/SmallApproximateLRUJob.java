...
//This is the small test case file for the Approximate LRU MMU
public class SmallApproximateLRUJob extends Job
{
 public SmallApproximateLRUJob(Tester theTester)
 {
     super(theTester);
 }
 ...
 public void run()
 {
     ...
     tester.performAccess(26885, AccessType.READ, 6405);
     tester.expectPageFault();
     tester.expectFillPage(29, 6);
     tester.performAccess(29782, AccessType.READ, 6230);
     tester.expectPageFault();
     tester.expectFillPage(26, 6);
     tester.performAccess(27538, AccessType.READ, 7058);
     tester.performAccess(2918, AccessType.READ, 5990);
     tester.performAccess(27055, AccessType.READ, 6575);
     ...
     tester.expectPageFault();
     tester.expectFillPage(26, 6);
     tester.performAccess(27139, AccessType.READ, 6659);
     ...
     tester.performAccess(26816, AccessType.READ, 6336);
     tester.performAccess(497, AccessType.READ, 3569);
     tester.expectPageFault();
     tester.expectFillPage(29, 0);
     tester.performAccess(30232, AccessType.READ, 536);
     tester.performAccess(30334, AccessType.READ, 638);
     tester.performAccess(2918, AccessType.WRITE, 5990);
     tester.performAccess(4720, AccessType.WRITE, 7792);
     tester.performAccess(26652, AccessType.READ, 6172);
     ...
     tester.performAccess(30125, AccessType.READ, 429);
     tester.performAccess(27015, AccessType.READ, 6535);
     tester.performAccess(1147, AccessType.READ, 4219);
     tester.expectPageFault();
     tester.expectFlushPage(3, 1);
     tester.expectFillPage(31, 1);
     tester.performAccess(32307, AccessType.READ, 1587);
     tester.performAccess(1577, AccessType.READ, 4649);
     tester.expectPageFault();
     tester.expectFillPage(3, 2);
     tester.performAccess(3094, AccessType.READ, 2070);
     tester.expectPageFault();
     ...
     tester.performAccess(3377, AccessType.WRITE, 2353);
     tester.performAccess(31813, AccessType.READ, 1093);
     tester.performAccess(3092, AccessType.READ, 2068);
     ...
     tester.performAccess(32257, AccessType.READ, 1537);
     tester.performAccess(4094, AccessType.READ, 3070);
     tester.performAccess(2194, AccessType.READ, 5266);
     tester.performAccess(1216, AccessType.READ, 4288);
     tester.performAccess(3219, AccessType.READ, 2195);
     tester.performAccess(32183, AccessType.READ, 1463);
     ...
     tester.performAccess(3162, AccessType.READ, 2138);
     tester.performAccess(32163, AccessType.READ, 1443);
     ...
     tester.performAccess(4071, AccessType.WRITE, 3047);
     tester.performAccess(31919, AccessType.READ, 1199);
     tester.performAccess(20699, AccessType.READ, 219);
     tester.performAccess(3533, AccessType.READ, 2509);
     tester.performAccess(21098, AccessType.READ, 618);
     tester.performAccess(20833, AccessType.READ, 353);
     tester.performAccess(3223, AccessType.WRITE, 2199);
     tester.performAccess(252, AccessType.READ, 3324);
     tester.performAccess(703, AccessType.READ, 3775);
     tester.performAccess(31888, AccessType.READ, 1168);
     ...
     tester.performAccess(12369, AccessType.READ, 6225);
